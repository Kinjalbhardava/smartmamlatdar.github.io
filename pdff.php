 ...
 <div class="cta d-none d-md-flex align-items-center">
  ...
  <section id="hero" class="d-flex flex-column justify-content-center align-items-center">
    <div class="container" data-aos="fade-in">
      ...
      <h2>Your appointment is few clikcs away.</h2>
	   <?php  if(!isset($_SESSION['namee'])){ ?>
      <div class="d-flex align-items-center">
	   ...
	   <?php }else{ ?>
	     ...
	     <div class="d-flex align-items-center">
        <i class="bx bxs-right-arrow-alt get-started-icon"></i>
        <a href="appointment.php" class="btn-get-started scrollto">Book Appointment</a>
      </div>
	   <?php } ?>
    </div>
  </section><!-- End Hero -->
...
if(isset($_POST['send']))
{
	...
	$query="INSERT into b_register values('','$name','$email','$dob','$gender','$password','$cpwd','$address')";
